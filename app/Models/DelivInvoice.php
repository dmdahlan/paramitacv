...
class DelivInvoice extends Model
{
    ...
    protected $column_order = array('idm_deliv', 'deliv_order.tgl', 'master_unit.nopol', 'deliv_order.orderan', 'dari', 'tujuan', 'customer', 'shipment', 'qty', 'tgl_inv', 'no_inv', 'billing', 'produk', 'shipment');
    protected $column_search = array('idm_deliv', 'deliv_order.tgl', 'deliv_order.orderan', 'dari', 'tujuan', 'master_unit.nopol', 'dari', 'outlet', 'customer', 'shipment', 'qty', 'tgl_inv', 'no_inv', 'billing', 'produk', 'shipment');
    ...
    private function _get_datatables_query()
    {
        $this->dt = $this->db->table('deliv_order')
            ...
            ->join('master_invoice', 'master_invoice.kode_inv=concat(deliv_order.dari_idm,deliv_order.tujuan_idm,deliv_order.orderan,deliv_order.produk_idm)', 'left')

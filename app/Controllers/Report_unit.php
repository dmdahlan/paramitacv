...
class Report_unit extends BaseController
{
    public function index()
    {
        ...
        return view('report/vw_reportunitbulan', $data);
    }
    public function repunit()
    {
        $tgl_awal  = $this->request->getPost('tgl_awal');
        $tgl_akhir = $this->request->getPost('tgl_akhir');

        $report = $this->reportunitbulan->reportUnit($tgl_awal, $tgl_akhir)->getResult();
        $recordTotal = $this->reportunitbulan->reportUnit($tgl_awal, $tgl_akhir)->getFieldCount();
        $recordFiltered = $this->reportunitbulan->reportUnit($tgl_awal, $tgl_akhir)->getFieldCount();

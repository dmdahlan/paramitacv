...
class Report_nopol extends BaseController
{
    public function index()
    {
        ...
        return view('report/vw_reportnopol', $data);
    }
    public function repnopol()
    {
        $tgl_awal  = $this->request->getPost('tgl_awal');
        $tgl_akhir = $this->request->getPost('tgl_akhir');

        $report = $this->reportnopol->reportnopoll($tgl_awal, $tgl_akhir)->getResult();
        $recordTotal = $this->reportnopol->reportnopoll($tgl_awal, $tgl_akhir)->getFieldCount();
        $recordFiltered = $this->reportnopol->reportnopoll($tgl_awal, $tgl_akhir)->getFieldCount();

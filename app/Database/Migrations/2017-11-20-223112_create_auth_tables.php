...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $fields = [
            ...
            'parent_menu'        => ['type' => 'VARCHAR', 'constraint' => 40, 'null' => true,],
            'sort_menu'          => ['type' => 'INT', 'constraint' => 11, 'null' => true],
            'is_active'          => ['type' => 'INT', 'constraint' => 1, 'default' => 0,],
        ];
        ...
        // tambah id sendiri
        $this->forge->addField($fields);
        $this->forge->addKey(['id', 'group_id', 'user_id']);
        $this->forge->addForeignKey('group_id', 'auth_groups', 'id', false, 'CASCADE');
        $this->forge->addForeignKey('user_id', 'users', 'id', false, 'CASCADE');
